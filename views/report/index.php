            ...
            <?= TabsX::widget([
                'items' => [
                    [
                        ...
                        'items'=>[
                            [
                                'label'=>Yii::t('app','Reportes atendidos'),
                                'encode'=>false,
                                'content'=>Yii::t('app','No report'),
                                'linkOptions'=>['data-url'=>Url::to(['report/control-report'])]
                            ],
                            [
                                'label'=>Yii::t('app','Reports por áreas'),
                                'encode'=>false,
                                'content'=>Yii::t('app','No report'),
                            ...
                            [
                                ...
                                'encode'=>false,
                                'content'=>Yii::t('app','No report'),
                                'linkOptions'=>['data-url'=>Url::to(['/report/categorias'])]
                            ],
                            [
