    ...
    <div class="box-footer">
        <div class="input-group">
            ...
            <div class="input-group-btn">
                ...
                <button class="btn btn-success btn-send-comment" data-url="<?=$url;?>"  data-model="<?=$userModel;?>" data-userfield="<?=$userField;?>" data-loading="<?=$loading;?>"><i class="fa fa-plus"></i>Enviar Respuesta</button>
            </div>
        </div>
    </div>
</div><!-- /.box (chat box) -->  